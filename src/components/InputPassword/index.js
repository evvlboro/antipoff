	...
	return (
		<div className="registration_form_input-container">
			<label htmlFor={id} className="registration_form_label">
				...
				<input
					type={passwordType}
					className={`registration_form_input ${passwordDirty && passwordError && 'registration_form_input_error'
						}`}
					id={id}
					name={name}
					required={isRequired}
				...
				<button
					...
					className={`registration_form_password-control ${passwordType === 'text' &&
